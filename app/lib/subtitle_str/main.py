...
from src.subtitles_generator.core import Model
from src.subtitles_generator.utils import create_srt, extract_audio
...
#SubtitlesGenerator("./TEST.mp4", PATH_TEMP+"/TEST.srt")